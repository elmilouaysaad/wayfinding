...
const translations = {
    en: {
        ...
        library_desc: "Library with extensive collection and study spaces",
        gym_desc: "Modern fitness center with equipment and classes",
        admissions_desc: "Offices for various administrative functions",
        sse_desc: "Dean of SSE: Dr. Salah Al-Majeed",
        sba_desc: "Dean of SBA: Dr. Lakshmi Goel",
        shass_desc: "Dean of SHASS: Dr. Asma Abbas",
        building_1_p_desc: "Right side of Building 1, has the office of the President and key administrative functions.",
        building_1_v_desc: "Left side of Building 1, has the office of the Vice President for Academic Affairs' office and business office.",
        aud4_desc: "Large auditorium used for major lectures, events, and presentations.",
    ...
    fr: {
        ...
        building_1_p_desc: "Côté droit du bâtiment 1, abrite le bureau du Président et les fonctions administratives clés.",
        building_1_v_desc: "Côté gauche du bâtiment 1, abrite le bureau du Vice-Président aux Affaires Académiques et le bureau des affaires.",
    },
    ar: {
        ...
        shass_desc: "عميدة كلية العلوم الإنسانية والفنون والعلوم الاجتماعية: Dr. Asma Abbas.  ",
        aud4_desc: "مدرج كبير يستخدم للمحاضرات الرئيسية والفعاليات والعروض التقديمية.",
        aud17_desc: "مدرج كبير للمحاضرات والفعاليات الخاصة.",
        building_1_p_desc: "الجانب الأيمن من المبنى 1، يحتوي على مكتب الرئيس والوظائف الإدارية الرئيسية.",
        building_1_v_desc: "الجانب الأيسر من المبنى 1، يحتوي على مكتب نائب الرئيس للشؤون الأكاديمية ومكتب الأعمال.",
    }
};
